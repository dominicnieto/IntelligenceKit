...
///
/// Unlike ReActAgent which parses tool calls from text output, LegacyAgent
...
/// print(result.output)
/// ```
public actor LegacyAgent: AgentRuntime {
    // MARK: Public
...
// MARK: - LegacyAgent DSL Extension

public extension LegacyAgent {
    /// Creates an LegacyAgent using the declarative builder DSL.
    ///
    /// Example:
    /// ```swift
    /// let agent = LegacyAgent {
